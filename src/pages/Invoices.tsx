...
import { HandyPayButton } from "@/components/HandyPayButton";
...
export default function Invoices() {
  ...
  const handleDownloadPDF = (invoice: Invoice) => {
    try {
      ...
      doc.text("The Pods", 105, 25, { align: "center" });
      
      doc.setFontSize(12);
      doc.setFont("helvetica", "normal");
      doc.text("6 University Dr, Kingston", 105, 35, { align: "center" });
      doc.text("info@thepods.com | 876-784-8380", 105, 42, { align: "center" });
      
      doc.setFontSize(8);
      doc.text("Powered by Unitly", 105, 50, { align: "center" });
      ...
      doc.text("Generated by Unitly - Property Management Platform", 105, 275, { align: "center" });
              ...
              {selectedInvoice.status !== "paid" && (
                <>
                  <HandyPayButton
                    ...
                    onPaymentInitiated={() => {
                      // Optionally refresh data when payment is initiated
                      console.log('Payment initiated for invoice', selectedInvoice.invoiceNumber);
                    }}
                  />
                  <Button
